<template>
    <div>
        ...
        <div class=" py-32 side-padding">
            ...
            <h3 class=" mt-20">Collection of your information</h3>
            <p>We may collect information about you in a variety of ways. The information we may collect on the Site includes</p>
            
            <h4 class=" mt-4">Personal Data</h4>
            <p>Personally, identifiable information, such as your name, residential address, email address, and telephone number. And demographic information, such as your age, gender, hometown, and interests, that you voluntarily give to us when you register with the Site or our mobile application, or when you choose to participate in various activities related to the Site and our mobile application, such as online chat and message boards. You are under no obligation to provide us with personal information of any kind, however your refusal to do so may prevent you from using certain features of the Site and our mobile application.</p>
            
            <h4 class=" mt-4">Financial Data</h4>
            <p>Financial information, such as data related to your payment method (e.g. valid credit card number, card brand, expiration date) that we may collect when you purchase, order, return, exchange, or request information about our services from the Site or our mobile application. We store only very limited, if any, financial information that we collect.</p>
        
            <h4 class=" mt-4">Derivative Data</h4>
            ...
            <h4 class=" mt-4">Data From Contests, Giveaways And Surveys</h4>
            <p>Personal and other information you may provide when entering contests or giveaways and/or responding to surveys.</p>

            <h4 class=" mt-4">Mobile Device Data</h4>
            <p>Device information, such as your mobile device ID, model, and manufacturer, and information about the location of your device, thus if you access the Site from a mobile device.</p>
        
            <h3 class=" mt-20">What Do We Use Your Information For?</h3>
            <p>Having accurate information about you permits us to provide you with a smooth, efficient, and customized experience. Specifically, we may use information collected about you via the Site or our mobile application to:
            </p>
            <ul class="mt-4 pl-5">
                <li>
                ...
                <li>
                    <p>Deliver targeted advertising, coupons, newsletters, and promotions, and other information regarding our website and mobile application to you.</p>
                </li>
                <li>
                ...
                <li>
                    <p>Fulfil and manage purchases, orders, payments, and other transactions related to the Site and our mobile application.</p>
                </li>
                <li>
                    <p>Increase the efficiency and operation of the Site and our mobile application.</p>
                </li>
                <li>
                    <p> Generate a personal profile about you to make future visits to the Site and our mobile application more personalised.</p>
                </li>
                <li>
                    <p>Monitor and analyse usage and trends to improve your experience with the Site and our mobile application. </p>
                </li>
                <li>
                    <p>Notify you of updates to the Site and our mobile application.</p>
                </li>
                <li>
            ...
            <h3 class=" mt-24">Disclosure Of Provided Information</h3>
            <p>We may share information we have collected about you in certain situations. Your information may be disclosed as follows:</p>

            <h4 class="mt-4">By Law To Protect Rights</h4>
            ...
            <h4 class="mt-4">Third Party Service Providers</h4>
            <p>We may share your information with third parties that perform services for us or on our behalf, including payment processing, data analysis, email delivery, hosting services, customer service, and marketing assistance.</p>

            <h4 class="mt-4">Affiliates</h4>
            ...
            <h4 class=" mt-4">Sale Or Bankruptcy</h4>
            ...
            <h4 class=" mt-4">Online Postings</h4>
            ...
            <h4 class="mt-4">Other Third Parties</h4>
            ...
            <h3 class="mt-24">Tracking Technologies</h3>

            <h4 class="mt-4">Cookies And Web Beacons</h4>
            <p>We may use cookies, web beacons, tracking pixels, and other tracking technologies on the Site and our mobile application to help customise the Site and our mobile application and improve your experience. For more information on how we use cookies, please refer to our Cookie Policy posted on the Site, which is incorporated into this Privacy Policy. By using the Site, you agree to be bound by our Cookie Policy.</p>

            <h4 class=" mt-4">Web Analytics</h4>
            <p>We may also collaborate with selected third-party vendors, such as Google Analytics, to allow tracking technologies and remarketing services on the site and our mobile application. This will be through the use of first party cookies and third-party cookies, to, among other things, analyse and track users use of the Site and our mobile application, determine the popularity of certain content and better understand online activity. By accessing the Site, our mobile application, you consent to the collection and use of your information by these third-party vendors. You are encouraged to review their privacy policy and contact them directly for responses to your questions. We do not transfer personal information to these third party vendors. You should be aware that getting a new computer, installing a new browser, upgrading an existing browser, or erasing or otherwise altering your browser’s cookies files may also clear certain opt-out cookies, plug-ins, or settings.</p>
        
            <h4 class="mt-4">Third Party Websites</h4>
            <p>The Site and our mobile application may contain links to third-party websites and applications of interest, including advertisements and external services that are not affiliated with us. Once you have used these links to leave the site or our mobile application, any information you provide to these third parties is not covered by this privacy policy. Moreover, we cannot guarantee the safety and privacy of your information. Before visiting and providing any information to any third-party websites, you should inform yourself of the privacy policies and practices (if any) of the third party responsible for that website, and should take those steps necessary to, in your discretion, protect the privacy of your information. We are not responsible for the content or privacy and security practices and policies of any third parties, including other sites, services or applications that may be linked to or from the Site or our mobile application.</p>

            <h4 class=" mt-4">Security Of Your Information</h4>
            ...
            <h4 class=" mt-4">Policy For Children</h4>
            <p>We do not knowingly solicit information from or market to children under the age of 18. If you become aware of any data, we have collected from children under age 18, kindly contact us using the contact information provided below</p>

            <h4 class="mt-4">Controls For Do Not Track (DNT) Features</h4>
            ...
            <h3 class=" mt-24">Options Regarding Your Information</h3>

            <h4 class="mt-4">Account information</h4>
            <p>You may at any time review or change the information in your account or terminate your account by: • Logging into user account settings and updating the user account. • Contacting us using the contact information provided Upon your request to terminate your account, we will deactivate or delete your account and information from our active databases. However, some information may be retained in our files to prevent fraud, troubleshoot problems, assist with any investigations, enforce our Terms of Use and/or comply with legal requirements.</p>

            <h4 class="mt-4">Emails and communications</h4>
            <p>If you no longer wish to receive correspondence, emails, or other communications from us, you may opt-out by: • Contacting us using the contact information provided. If you no longer wish to receive correspondence, emails, or other communications from third parties, you are responsible for contacting the third party directly.</p>
        
            <div class=" mt-24 border-b border-t border-gray-300 py-24">
                <h3>Contact us.</h3>
                ...
                <div class=" grid grid-cols-1 lg:grid-cols-3 gap-5 mt-5">
                    ...
                    <div>
                        ...
                        <p>Ghana: <br/>+233 202-822-169<br/> +233 302-906-492<br/> <br/> United Kingdom: <br/>+447393535139<br/> E-mail: <br/>inquiries@afarmforme.com</p>
                    </div>
                    <div></div>
                </div>
            </div>
            ...
            <div class=" w-full flex justify-center pt-20">
                <p>Last updated: 20th June, 2020.</p>
            </div>
